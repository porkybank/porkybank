...
config :porkybank, PorkybankWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "h55Wb/x5sHZbJs14poSTbx09WTYMt2am8BZjdnou/+z4PlQ0aiX7Y5FuyDyuiW1K",
  watchers: [
...
config :porkybank, PorkybankWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/porkybank_web/(controllers|live|components|styles)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :porkybank, dev_routes: true
