defmodule Porkybank.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :expenses, Porkybank.Banking.Expense
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Porkybank.Repo)
  ...
  """
  def valid_password?(%Porkybank.Accounts.User{hashed_password: hashed_password}, password)
